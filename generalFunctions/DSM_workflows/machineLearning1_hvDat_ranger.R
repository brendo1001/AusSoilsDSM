...
## ranger with tune grid and cross validation
tgrid <- expand.grid(
  .mtry = 2:11,
...
ranger.model<-train(x= DSM_data_c[,5:15], y= DSM_data_c$pH60_100cm,method = "ranger",tuneGrid = tgrid,trControl =trainControl(method = "cv"), num.trees = 1000)  
summary(ranger.model)
ranger.model
...
ranger.model<-train(x= DSM_data_c[,5:15], y= DSM_data_c$pH60_100cm,method = "ranger",tuneGrid = tgrid,trControl =trainControl(method = "oob"), num.trees = 1000)  
ranger.model<-train(x= DSM_data_c[,5:15], y= DSM_data_c$pH60_100cm,method = "ranger",tuneGrid = tgrid,trControl =trainControl(method = "boot",number = 5), num.trees = 1000)  
ranger.model<-train(x= DSM_data_c[,5:15], y= DSM_data_c$pH60_100cm,method = "ranger",trControl =trainControl(method = "oob"), num.trees = 1000,importance = 'impurity')  
