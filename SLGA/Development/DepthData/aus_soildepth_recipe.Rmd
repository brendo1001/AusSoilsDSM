...
* model shallow soils seperately
* Include the new climate data
* spatial modelling of the residuals
...
* Spatial prediction of continuous and cateogrical map outputs (per tile estimation)
...
* Integration of continuous and categorical map outputs to derive products (13 products derived).

* Tile mosaicing of all outputs
