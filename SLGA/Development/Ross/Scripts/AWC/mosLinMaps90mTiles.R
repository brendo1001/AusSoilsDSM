...
if(machineName=='TERNSOIL2'){
  basePath <- '/scratch1/sea084/SLGA/AWCLin'
}else{
  basePath <- '/scratch1/sea084/SLGA/AWCLin'
}
...
outDir <- paste0('/datasets/work/af-digiscapesm/work/Ross/SLGA/SLGA/Development/AWC/Outputs/LinMaps')
if(!dir.exists(outDir)){dir.create(outDir, recursive = T)}
outFile <- paste0(outDir, '/', att, "_LinMaps_", itr, '.tif')
