...
if(machineName=='TERNSOIL2'){
  ...
  mosaicsDir <- paste0('//fs1-cbr.nexus.csiro.au/{af-digiscapesm}/work/Ross/SLGAData/FPARes')
  ...
  mosaicsDir <- paste0('/datasets/work/af-digiscapesm/work/Ross/SLGAData/FPARes')
