...
if(machineName=='TERNSOIL2'){
  ...
  inDir <- '/datasets/work/af-tern-mal-deb/work/Ross/New/Auscover/Tiles/alpsbk_aust_y2009_se5a2'
  outDir <- '/datasets/work/af-tern-mal-deb/work/Ross/New/Auscover/TilesResamp/alpsbk_aust_y2009_se5a2'
