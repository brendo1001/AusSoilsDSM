...
if(machineName=='TERNSOIL2'){
  ...
  inDir <- '/datasets/work/af-tern-mal-deb/work/datasets/national/covariates/landcover/GAMosaics'
  outDir <- '/datasets/work/af-tern-mal-deb/work/datasets/national/covariates/landcover/GAResampled'
