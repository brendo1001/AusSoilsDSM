...
if(machineName=='TERNSOIL2'){
  ...
  inDir <- '//fs1-cbr.nexus.csiro.au/{af-tern-mal-deb}/work/Ross/FC/FCMosaicsResample'
  outDir <- '//fs1-cbr.nexus.csiro.au/{af-tern-mal-deb}/work/Ross/FCMask'
  ...
  outDir <- '/datasets/work/af-tern-mal-deb/work/Ross/FC/FCMask'
...
rz<- mask(r, templateR , filename = outfile, datatype='INT1U', overwrite=T)
